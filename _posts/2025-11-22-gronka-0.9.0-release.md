...
```bash
docker pull ghcr.io/thedorekaczynski/gronka:0.9.0
```
...
download the source archive from the [github release](https://github.com/thedorekaczynski/gronka/releases/tag/v0.9.0) or clone the repository:
...
- [release page](https://github.com/thedorekaczynski/gronka/releases/tag/v0.9.0)
- [docker image](https://github.com/thedorekaczynski/gronka/pkgs/container/gronka)
