...
// Moderation endpoints for R2 uploads

// Get R2 media files for a user
app.get('/api/moderation/users/:userId/r2-media', async (req, res) => {
  try {
    const { userId } = req.params;
...
app.delete('/api/moderation/files/bulk', express.json(), async (req, res) => {
  try {
...
app.delete('/api/moderation/files/:urlHash', express.json(), async (req, res) => {
  try {
...
app.delete('/api/moderation/users/:userId/r2-media', express.json(), async (req, res) => {
  try {
    const { userId } = req.params;
